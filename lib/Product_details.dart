                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(' Blazer', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300,fontSize: 20),),
                          ),

                          Padding(
                            padding: const EdgeInsets.all(10.0),
                            child: Text('950', textAlign: TextAlign.end,style: TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold),),
                          ),
                        ],
                      ),
                    )),
